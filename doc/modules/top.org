...
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/records/pdef/depInfo/interface.nix][<floco>/records/pdef/depInfo/interface.nix]]
...
is fraught.
- type :: boolean
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/records/pdef/depInfo/single.interface.nix][<floco>/records/pdef/depInfo/single.interface.nix]]
...
maintained software.
- type :: null or semantic version string
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/records/pdef/depInfo/single.interface.nix][<floco>/records/pdef/depInfo/single.interface.nix]]
...
- type :: module
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/records/pjsCore/interface.nix][<floco>/records/pjsCore/interface.nix]]

**** =cpu=
- option :: ~floco.records.pjsCore.cpu~
- type :: list of string
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/records/pjsCore/interface.nix][<floco>/records/pjsCore/interface.nix]]

**** =dependencies=
- option :: ~floco.records.pjsCore.dependencies~
- description :: Dependency declarations as attrs of ={ <NAME> = <DESCRIPTOR>; }=
describing the required version ranges or location of a given dependency.
- type :: attribute set of (semantic version string or string)
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/records/pjsCore/interface.nix][<floco>/records/pjsCore/interface.nix]]
- example ::
#+BEGIN_SRC nix
{
...
**** =devDependencies=
- option :: ~floco.records.pjsCore.devDependencies~
- description :: Dependency declarations as attrs of ={ <NAME> = <DESCRIPTOR>; }=
describing the required version ranges or location of a given dependency.
- type :: attribute set of (semantic version string or string)
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/records/pjsCore/interface.nix][<floco>/records/pjsCore/interface.nix]]
...
**** =devDependenciesMeta=
- option :: ~floco.records.pjsCore.devDependenciesMeta~
- description :: Dependency metadata/options declarations.
...
**** =engines=
- option :: ~floco.records.pjsCore.engines~
- type :: attribute set of string
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/records/pjsCore/interface.nix][<floco>/records/pjsCore/interface.nix]]
- example ::
#+BEGIN_SRC nix
...
**** =ident=
- option :: ~floco.records.pjsCore.ident~
- description :: Package identifier/name as found in =package.json:.name=.
- type :: package identifier/name
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/records/pjsCore/interface.nix][<floco>/records/pjsCore/interface.nix]]
- example :: =@floco/foo=
...
**** =key=
- option :: ~floco.records.pjsCore.key~
- description :: Unique key used to refer to this package in =tree= submodules and other
=floco= configs, metadata, and structures.
- type :: string
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/records/pjsCore/interface.nix][<floco>/records/pjsCore/interface.nix]]
...
**** =name=
- option :: ~floco.records.pjsCore.name~
- description :: Alias of <option>ident</option>.
- type :: package identifier/name
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/records/pjsCore/interface.nix][<floco>/records/pjsCore/interface.nix]]

**** =optionalDependencies=
- option :: ~floco.records.pjsCore.optionalDependencies~
- description :: Dependency declarations as attrs of ={ <NAME> = <DESCRIPTOR>; }=
describing the required version ranges or location of a given dependency.
- type :: attribute set of (semantic version string or string)
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/records/pjsCore/interface.nix][<floco>/records/pjsCore/interface.nix]]
...
**** =os=
- option :: ~floco.records.pjsCore.os~
- type :: list of string
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/records/pjsCore/interface.nix][<floco>/records/pjsCore/interface.nix]]

**** =peerDependencies=
- option :: ~floco.records.pjsCore.peerDependencies~
- description :: Dependency declarations as attrs of ={ <NAME> = <DESCRIPTOR>; }=
describing the required version ranges or location of a given dependency.
- type :: attribute set of (semantic version string or string)
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/records/pjsCore/interface.nix][<floco>/records/pjsCore/interface.nix]]
...
- option :: ~floco.records.pjsCore.peerDependenciesMeta~
- description :: Dependency metadata/options declarations.
Represented as attrs of ={ <NAME> = { <OPTION> = <BOOL>; }; }= indicating
additional metadata about dependencies that cannot be inferred from
their category.
...
**** =version=
- option :: ~floco.records.pjsCore.version~
- description :: Package version as found in =package.json:.version=.
- type :: semantic version string
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/records/pjsCore/interface.nix][<floco>/records/pjsCore/interface.nix]]
- example :: =4.2.0=
...
***** =cycle=
- option :: ~floco.topo.toposortNoPins.<function body>.cycle~
- type :: list of anything
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/topo/interface.nix][<floco>/topo/interface.nix]]

***** =isDAG=
- option :: ~floco.topo.toposortNoPins.<function body>.isDAG~
- type :: boolean
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/topo/interface.nix][<floco>/topo/interface.nix]]

***** =loops=
- option :: ~floco.topo.toposortNoPins.<function body>.loops~
- type :: list of anything
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/topo/interface.nix][<floco>/topo/interface.nix]]

***** =result=
- option :: ~floco.topo.toposortNoPins.<function body>.result~
...
***** =cycle=
- option :: ~floco.topo.toposortPins.<function body>.cycle~
- type :: list of anything
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/topo/interface.nix][<floco>/topo/interface.nix]]

***** =isDAG=
- option :: ~floco.topo.toposortPins.<function body>.isDAG~
- type :: boolean
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/topo/interface.nix][<floco>/topo/interface.nix]]

***** =loops=
- option :: ~floco.topo.toposortPins.<function body>.loops~
- type :: list of anything
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/topo/interface.nix][<floco>/topo/interface.nix]]

***** =result=
- option :: ~floco.topo.toposortPins.<function body>.result~
- type :: null or (list of anything)
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/topo/interface.nix][<floco>/topo/interface.nix]]
...
**** =cycle=
- option :: ~floco.topo.toposortedAll.cycle~
- type :: list of anything
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/topo/interface.nix][<floco>/topo/interface.nix]]

**** =isDAG=
- option :: ~floco.topo.toposortedAll.isDAG~
- type :: boolean
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/topo/interface.nix][<floco>/topo/interface.nix]]

**** =loops=
- option :: ~floco.topo.toposortedAll.loops~
- type :: list of anything
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/topo/interface.nix][<floco>/topo/interface.nix]]

**** =result=
- option :: ~floco.topo.toposortedAll.result~
- type :: null or (list of anything)
- from :: [[https://github.com/aakropotkin/floco/blob/main/modules/topo/interface.nix][<floco>/topo/interface.nix]]
