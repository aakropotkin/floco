...
** Providing a Shared Library for =libzmq=

While this portion of the guide is completely optional, it gives use the
opportunity to talk about a few other common modifications to build recipes
that you may need to use in your own projects.
