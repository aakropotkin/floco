...
[[file:doc/scripts/README.org::*Core Scripts][Core Scripts]].
...
[[file:doc/guides/basics.org][Getting Started guide]].
...
For example usage please see the
[[file:doc/guides/native-deps.org::*Preparing a Workspace][Native Dependencies guide]].
