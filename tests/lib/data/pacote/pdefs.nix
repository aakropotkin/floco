  ...
  floco = {
    pdefs = {
      ...
      lru-cache = {
        ...
        "7.18.3" = {
          fetchInfo = {
            narHash = "sha256-jYTghgbO9IvPgjbSPe3qR5RBZ4NdqBBgGmnpR948fk8=";
            type = "tarball";
      ...
      minipass = {
        ...
        "4.2.4" = {
          fetchInfo = {
            narHash = "sha256-dLxPh6rc4NRKShVRdVQvUx3lRthKTZ9DrcLlNG/QyTI=";
            type = "tarball";
      ...
      readable-stream = {
        "3.6.1" = {
          ...
          fetchInfo = {
            narHash = "sha256-+vj4lKEDlpfPxkk40Bd3ylXwc8t1fwE9yFk+ennKg1U=";
            type = "tarball";
